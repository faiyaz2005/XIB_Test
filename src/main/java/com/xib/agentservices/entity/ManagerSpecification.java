...
public class ManagerSpecification {
	...
	public static Specification<Manager> searchManager(AgentManagerFilter agentManagerFilter) {
		return (root, cq, cb) -> {
	...
	private static Optional<Predicate> filterPredicate(AgentManagerFilter filter, Root<Manager> root, CriteriaBuilder cb) {
